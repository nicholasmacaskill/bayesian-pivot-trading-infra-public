...
def calculate_probability():
    print("🦁 Sovereign System: Calculating 80k Probability by THIS TIME TOMORROW...")
    ...
    # 7. Final Verdict
    print("\n🎲 SYSTEM PROBABILITY (24H):")
    
    # Math: 
    # 1 ATR move in 24h = ~68% probability (1 SD)
    # 2 ATR move in 24h = ~32% or less? Logistically 1.88 ATR is significant.
    ...
    print(f"   Confidence Level: {'MODERATE' if prob_score > 30 else 'LOW'}")
