...
We've made it easier to run the scanner without memorizing long commands.

| Command | Description | Use Case |
| :--- | :--- | :--- |
| `./yard` | Runs the scanner + keeps Mac awake (**Caffeinated**) | **Yard Mode**: When you want to step away for hours. |
| `./run` | Runs the scanner normally (Standard) | **Quick Check**: When you are at the desk testing things. |
