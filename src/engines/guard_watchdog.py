...
# Configuration
MONITOR_SCRIPT = "guard_monitor.py" # In the same src/ directory
...
def run_supervisor():
    ...
    while True:
        try:
            ...
            out_log = path_utils.get_log_file("guard_monitor.out")
            err_log = path_utils.get_log_file("guard_monitor.err")
            ...
            with open(path_utils.get_run_file("monitor_pid.txt"), "w") as f:
